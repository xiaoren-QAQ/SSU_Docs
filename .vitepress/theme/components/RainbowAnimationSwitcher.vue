...
<template>
  <ClientOnly>
    <div :class="{ mobile: screenMenu }" class="group">
      <div class="NavScreenRainbowAnimation">
        <p class="text">
          {{ text ?? 'Rainbow Animation' }}
        </p>
        <RainbowSwitcher :aria-checked="animated ? 'true' : 'false'" :title="switchTitle"
                         class="RainbowAnimationSwitcher" @click="toggleRainbow">
