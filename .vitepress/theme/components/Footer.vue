  ...
  <div v-if="frontmatter.footer !== false" class="slide-enter footer-container">
    ...
    <footer class="footer-bottom">
      <div class="license-container">
        <svg class="license-icon" clip-rule="evenodd" fill-rule="evenodd" height="24" style="color: var(--vp-c-text-2)"
      ...
      <div class="social-links-container">
        <a v-for="item in Object.values(socialList)" :key="item.title" :aria-label="item.title" :href="item.link"
           :title="item.title" class="footer-sociallink" rel="noopener noreferrer" target="_blank" v-html="item.icon"/>
      </div>
    </footer>
  </div>
</template>
